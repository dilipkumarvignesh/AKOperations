 ...
 *
 */
public class DelActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    private Button btn_location,btn_delivery;
    ProgressBar progressIndicator;
    TextView SchoolName,Quantity;
    EditText TempQuantity;
    private String RouteValue,LocationValue;
    ...
    int i=0;
    int schoolSize=0;
    ArrayList<SchoolData> schoolData = new ArrayList<SchoolData>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressIndicator =(ProgressBar)findViewById(R.id.determinateBar);
        SchoolInfoLayout = (LinearLayout)findViewById(R.id.SchoolInfolayout);
        SchoolName = (TextView)findViewById(R.id.mSchoolName);
        Quantity = (TextView)findViewById(R.id.mQuantity);
        TempQuantity = (EditText)findViewById(R.id.mTempQuantity);
        SchoolInfoLayout.setOnTouchListener(new OnSwipeTouchListener(this) {
            @Override
...
//        tv_pincode=(TextView)findViewById(R.id.tv_pincode);
        ...
        Bundle extras = getIntent().getExtras();
         RouteValue = extras.getString("Route");
         LocationValue = extras.getString("Location");

        Log.d("info","RouteLocation:"+LocationValue);
        getRouteData(RouteValue,LocationValue);

    }
    public void next_school()
    {
        i++;
        Toast.makeText(this,"I Addded "+i ,Toast.LENGTH_LONG).show();
        setSchoolDataUi();
    }
    public void previous_school()
    {
        i--;
        Toast.makeText(this,"I Subtracted "+i,Toast.LENGTH_LONG).show();

    }
    public void getRouteData(String RouteValue,String LocationValue) {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            //    Log.d("info","Datasnapshot:"+dataSnapshot.getChildren());
                for (DataSnapshot routeSnapShot : dataSnapshot.getChildren()) {
                    ...
                    SchoolData school = routeSnapShot.getValue(SchoolData.class);
                    schoolData.add(school);
                    Log.d("info","Schools size:"+schoolData.size());
                    Log.d("info", "School Name:" + school.School);
    ...
    public void onResult(LocationSettingsResult locationSettingsResult) {
        ...
        switch (status.getStatusCode()) {
            case LocationSettingsStatusCodes.SUCCESS:
                ...
                Toast.makeText(DelActivity.this, "Location is already on.", Toast.LENGTH_SHORT).show();
                startLocationUpdates();
                break;
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    ...
                    // in onActivityResult().
                    Toast.makeText(DelActivity.this, "Location dialog will be open", Toast.LENGTH_SHORT).show();
                    //

                    //move to step 6 in onActivityResult to check what action user has taken on settings dialog
                    status.startResolutionForResult(DelActivity.this, REQUEST_CHECK_SETTINGS);
...
//                    mLastUpdateTime));
    ...
    private void updateCityAndPincode(double latitude, double longitude)
    {
        try
        {
            Geocoder gcd = new Geocoder(DelActivity.this, Locale.getDefault());
